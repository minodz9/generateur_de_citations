...
let citations = [
  ...
  [
    "C'était la meilleure fonctionnalité du site ! Il a corrigé de nombreux problèmes de grammaire que même mon tuteur d'écriture avait négligés.",
    "Amine.A",
  ],
  [
    "Les suggestions de grammaire ont détecté des erreurs que je n'aurais certainement pas détectées par moi-même, ce qui a rendu mon article tellement meilleur.",
    "Amine.B",
  ],
];
...
btn.addEventListener("click", () => {
  do {
    nombreAleatoire = generateNombreEntier(citations.length);
